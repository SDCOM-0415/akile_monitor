...
alpine特别版
```
wget -O setup-client.sh "https://az-kr.sdcom-ghproxy.us.kg/https://raw.githubusercontent.com/SDCOM-0415/akile_monitor/refs/heads/main/alpine-client.sh" && chmod +x setup-client.sh && sudo ./setup-client.sh <your_secret> <url> <name>
```
